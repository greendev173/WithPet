...
/**
 * Servlet implementation class UpdateReviewEndServlet
 */
@WebServlet("/member/updateReviewEnd")
public class UpdateReviewEndServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new MemberService().updateReview(rv);
		...
		if(result > 0){
			msg = "리뷰를 성공적으로 수정하였습니다.";
			loc = "/close";
		} else {
			msg = "리뷰수정에 실패하였습니다. 다시시도하세요.";
