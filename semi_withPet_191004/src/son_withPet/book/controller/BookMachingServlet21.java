...
/**
 * Servlet implementation class BookMachingServlet21
 */
@WebServlet("/book/book022")
public class BookMachingServlet21 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BookMachingServlet21() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/book/book022.jsp").forward(request, response);
