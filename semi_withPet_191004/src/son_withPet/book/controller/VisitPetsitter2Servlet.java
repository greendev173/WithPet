 ...
 */
@WebServlet("/book/petsitterHome2")
public class VisitPetsitter2Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String viewPath="/views/homePetsitter/book2.jsp";
...
//				detailAddressC.setPath("/semi_withPet/book"); // 쿠키 경로 지정
		...
		request.getRequestDispatcher("/views/homePetsitter/book2.jsp").forward(request, response);
