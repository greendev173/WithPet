...
/**
 * Servlet implementation class BookMachingServlet
 */
@WebServlet("/book/book04")
public class BookMachingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BookMachingServlet() {
        super();
...
//		request.setAttribute("standard", standard);
		...
		request.getRequestDispatcher("/book/book04.jsp").forward(request, response);
