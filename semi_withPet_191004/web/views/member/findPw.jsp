...
<style>
		...
		<!-- <div class="parallax-overlay"></div> -->
			...
			<div class="banner-title-content">
	        	<div class="text-center">
		        	...
		        	<ul class="breadcrumb">
			            <li>Home</li>
			            <li><a href="<%=request.getContextPath()%>/findPw"> 비밀번호찾기</a></li>
		          	</ul>
	          	</div>
	...
	<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
		<form action="<%=request.getContextPath()%>/memberFindPw"
			method="post" id="find-form">
				<div class="form-group" >
					...
					<div class="text-center">
					<input type="submit" class="btn btn-outline-primary" value="비밀번호찾기">
					</div>
			</div>
		</form>
	</div>
