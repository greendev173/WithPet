...
<body>
	...
	<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
		...
		<form action="<%=request.getContextPath() %>/member/updateReviewEnd" method="POST" id="write_form">
			<div id="input-header">
			...
			<div id="input-review">
				<textarea id="reviewText" name="revContent" cols="50" rows="5"><%=rv.getRevContent() %></textarea>
			</div>
			<!-- hidden 전송값 -->
			<input type="hidden" name="payNo" value="<%=rv.getPayNo()%>"/>
			...
			<div class="form-group" id="auth-button">
				<button class="btn btn-outline-primary" onClick="fn_write();" id="btn-write">수정완료</button>
