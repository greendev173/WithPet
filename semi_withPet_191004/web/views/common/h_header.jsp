						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								...
								<div class="dropdown-menu">
									<ul>
										<li><a href="<%=request.getContextPath() %>/service.jsp">Easy Matching</a></li>
										<!--매칭 시작-->
										<li><a href="<%=request.getContextPath() %>/book_2/matching.jsp">선택 매칭하기</a></li>
										<!--펫시터만 검색-->
							...
							<%if(loginMember != null) {%>
									...
									<li><a href="<%=request.getContextPath() %>/adminPage/adminMain.jsp">관리자페이지</a></li>
								<%}} else { %>
