        ...
        <div class="container-fluid">
            ...
            <div class="row middle">
                <div class="col-12 centerClass">
                    ...
                    <form action="<%=request.getContextPath()%>/book/petsitterHomeEnd" method="POST">
                        <div class="row">
                            <div class="col-12"><span class='input-text'>펫시터 타입</span></div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                            <input class="readonlyInput" readonly type="text" name="petsitterType" value="<%=petsitterType %>"></div>
                        </div>
                        <div class="row empty3"></div>
                        <div class="row">
                            <div class="col-12"><span class='input-text'>우편번호</span></div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12"><span class='input-text'>주소</span></div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-6"><input type='button'' class='btn-primary form-control submitBtn' value='이전'
                                onclick="location.href='<%=path%>/book/visitPetsitter4';"></div>
                            <div class="col-6"><input type='submit' class='btn-primary form-control submitBtn' value='결제' id="payment"></div>
                        </div>
                        <div class="row empty3"></div>
                    </form>
            </div>
