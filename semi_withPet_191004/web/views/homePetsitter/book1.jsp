...
<head>
    ...
    <title>가정집 펫시터 예약 - step 1/4</title>
</head>
...
<body>
    ...
    <div class="container-fluid"  style="height: 90%;">
        ...
        <div class="row middle">
            <div class="col-12">
                <form action="<%=request.getContextPath()%>/book/petsitterHome2" method="post" onsubmit="return book1_Validate();">
                    <div class="row empty3"></div>
                    <div class="row">
                        <div class="col-12" id="printPetsitterType">
                            가정집 펫시터 예약을 위해<br>펫시터와 만나는 장소를 정해주세요!
                        </div>
                    </div>
                    <div class="row empty3"></div>
                    <div class="row">
