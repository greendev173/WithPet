	...
	<section id="main-container" class="portfolio portfolio-box">
		<div class="container">
			...
			$('#area_all').on("click",function(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=all";
			});
				
			function seoul(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=seoul";
			}
			
			function incheon(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=incheon";
			}
			
			function gyeonggi(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=gyeonggi";
			}
			
			function busan(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=busan";
			}
			
			function daegu(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=daegu";
			}
			
			function gwangju(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=gwangju";
			}
			
			function deajeon(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=deajeon";
			}

			function woolsan(){
				location.href = "<%=request.getContextPath() %>/masterPetsitterList?area=woolsan";
			}
